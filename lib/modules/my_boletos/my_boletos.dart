...
class MyBoletos extends StatefulWidget {
  const MyBoletos({Key? key}) : super(key: key);

  @override
  State<MyBoletos> createState() => _MyBoletosState();
}

class _MyBoletosState extends State<MyBoletos> {
